...
test('json edits are structural and idempotent', () => {
  ...
  assert.equal(setJsonPath(manifest, 'devDependencies.makerkit-ax', 'github:flosrn/ax#v0.1.0'), true);
  assert.equal(getJsonPath(manifest, 'devDependencies.makerkit-ax'), 'github:flosrn/ax#v0.1.0');
