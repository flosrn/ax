  ...
  },
  {
    ...
    verbOptions: {
      dispatch: [
        ...
        ['--capability <class>', 'routine, standard or deep; the class dispatch.models routes'],
        ['--model-mode <mode>', 'auto (default), manual or ask; overrides dispatch.modelMode'],
        ...
        ['--wait <s>', 'seconds to prove role and model; 0 skips verification'],
