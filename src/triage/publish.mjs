 ...
 *
 * That is the reason the three wordings differ by job instead of by decoration.
 ...
 * #50-#61, #98 and #100, and `refine` had never run there at all. That hole is
...
const DISCLAIMER_BY_JOB = {
  ...
  refine: '> *This was generated by AI during refinement.*',
};

/**
 * Every rendering a publication can have on the tracker: one per wording, and
 * the pre-0.15 shared line is among them because it IS the triage wording.
 *
