...
function reportContract(report) {
  ...
  return [
    ...
    '  in for it.',
    '- **An artifact your repository requires as evidence of this change belongs IN the pull request** —',
    '  a review report its instructions demand for a migration, a capture your ticket names as proof, a',
    '  query plan, whatever was asked for. The directory holding your Report is not a delivery channel:',
    '  it is not committed, it does not travel with your branch, and it is REMOVED with this worktree',
    '  once the slice lands — so an artifact left there is evidence nobody reviewing your work can',
    '  reach. Reference it from your Report by all means; deliver it where it is read. Anything',
    '  regenerable from the merged pull request — a diff, a list of touched files — is not evidence and',
    '  belongs nowhere: writing it beside your Report makes the cleanup of this worktree a decision',
